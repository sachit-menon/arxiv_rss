...
def get_arxiv_query(author_name: str, include_abbrev: bool = False)->str:
    ...
    if include_abbrev:
        ...
        return f'http://export.arxiv.org/api/query?search_query=au:%22{author_name_query}%22&sortBy=submittedDate&sortOrder=descending&max_results=100'.replace('&', '&amp;')
